...
if __name__ == '__main__':
    ...
    parser.add_argument('--wav_path', required=True, help='test data file')
    ...
    waveform, sample_rate = torchaudio.load_wav(args.wav_path)

    feat = kaldi.fbank(
        waveform,
        num_mel_bins=configs['mel_bins'],
    ...
    with torch.no_grad(), open(args.result_file, 'w') as fout:
        ...
        for w in hyps[0]:
            if w == eos:
                break
            content += char_dict[w]
        logging.info('{} {}'.format(args.wav_path, content))
        fout.write('{} {}\n'.format(args.wav_path, content))
